document.getElementById('contact-form').addEventListener('submit', function(event) {
    ...
    const pickUpLocation = encodeURIComponent(document.getElementById('pick-up-location').value.trim());
    const pickUpContact = encodeURIComponent(document.getElementById('pick-up-contact').value.trim());
